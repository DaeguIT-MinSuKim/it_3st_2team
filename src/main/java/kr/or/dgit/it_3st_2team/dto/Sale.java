...
public class Sale { //Foreign key에 대한 변수타입 수정 kim 2018-02-22
	...
	public String toString() {
		return String.format("Sale [saleNo=%s, description=%s, sDate=%s, sTime=%s, cus=%s, emp=%s, evn=%s, sPrice=%s,hair=%s]",
				saleNo, description, sDate, sTime, cus, emp, evn, sPrice,hair);
	}
/*	yyj*/
	...
	public String timeToStrong(Date stime) {
