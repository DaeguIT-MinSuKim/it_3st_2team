...
public class Sale { //Foreign key에 대한 변수타입 수정 kim 2018-02-22
	...
	public Sale(int saleNo, String description, Date sDate, Date sTime, Customer cus, Employee emp,
			Event evn, int sPrice) {
		super();
		this.saleNo = saleNo;
	...
	public String toString() {
		return String.format(
				"Sale [saleNo=%s, description=%s, sDate=%s, sTime=%s, cus=%s, emp=%s, evn=%s, sPrice=%s]",
